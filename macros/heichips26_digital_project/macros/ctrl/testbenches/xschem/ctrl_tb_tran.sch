...
meas tran t_rise1 when v(vosc)=0.75 rise=3
meas tran t_rise2 when v(vosc)=0.75 rise=4
...
C {devices/vsource.sym} 120 -390 0 0 {name=ven value="pulse(0 1.5 100p 100p 100p 3n 6n)"
}
