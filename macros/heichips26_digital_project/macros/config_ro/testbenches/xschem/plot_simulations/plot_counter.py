...
# Author: Simon Dorrer
# Description: Transient plots for the config_ro macro based on ngspice exports.
# ============================================
...
def main():
    ...
    # ------------------------------------------------------------------
    ngspice_file = data_dir / "config_ro_tb_tran.txt"
    ...
    fig1.suptitle('config_ro - Gate-Level Transient Simulation')
    ...
    # ------------------------------------------------------------------
    fig1.savefig(str(figures_dir / "config_ro_tb_tran.svg"), bbox_inches='tight')
    fig1.savefig(str(figures_dir / "config_ro_tb_tran.pdf"), bbox_inches='tight')
    np.savetxt(
        str(figures_dir / "config_ro_tb_tran.csv"),
        np.column_stack((
