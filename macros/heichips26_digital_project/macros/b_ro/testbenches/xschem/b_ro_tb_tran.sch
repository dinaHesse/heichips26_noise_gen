...
node="enable
vosc"}
T {Testbench for transient analysis b_ro
} 600 -1730 0 0 1 1 {}
N 420 -600 420 -560 {
lab=VDD}
N 420 -500 420 -460 {
...
only_toplevel=false
value="
.include ../../../netlist/xspice/b_ro.xspice
.include ../../../netlist/pex/b_ro_magic_pex_3.spice
.param VDD=1.5
.param temp=27
...
"}
C {b_ro.sym} 1210 -830 0 0 {name=x1
spice_ignore=true}
C {b_ro_pex.sym} 1100 -440 0 0 {name=x2
}
